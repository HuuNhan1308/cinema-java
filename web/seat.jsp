...
<html lang="en">
    ...
    <div class="flex flex-row lg:gap-2 lg:mt-8 mt-[5px] gap-2">
      ...
      <div class="info-film ml-[110px] max-w-[470px] lg:mt-[-5%] md:mx-16 lg:mx-20 xl:mx-16 flex flex-col gap-4">
        <div class="shadow-2xl p-10 px-20 flex flex-col gap-2">
          ...
          <!-- description -->
          <h1 class="max-w-[250px] text-center xl:text-4xl lg:text-2xl font-bold">${showtime.getMovie().getTitle()}</h1>
          <div id="price" data-price="${showtime.getPrice()}" class="text-sm xl:text-lg lg:text-lg text-center">
            Retail: 
            <span class="font-bold"> ${showtime.getPrice()}đ</span>
          </div>

          <!-- calculate price -->
          <div class="py-2 border-t-2 border-slate-600 max-w-[270px]">
            <!-- positions -->
              ...
              <div class="p-4 md:p-5 space-y-4">
                  <ol class="relative border-s border-gray-200 ms-3.5 mb-4 md:mb-5">
                    <li class="mb-10 ms-8">
                      ...
                      <div id="modalStandardPrice" class="block mb-3 text-sm font-normal leading-none text-gray-500">Price
                      </div>
                    </li>
  ...
  <script>
    ...
    function changeColor(input, seatNumber) {
      ...
      totalPriceElement.innerHTML = totalPrice + 'đ';
    ...
    function setDataConfirmModal() {
      ...
      document.getElementById('modalStandardPrice').innerHTML = standardPrice + 'đ';
      document.getElementById('modalVipPrice').innerHTML = vipPrice + 'đ';
      document.getElementById('modal-total-price').innerHTML = totalPrice + 'đ';
