     ...
     <div class="p-4 md:p-5">
       <form class="space-y-4" method="post" action="<%=root%>/login">
        <div>
          ...
          <label for="email-forgot" class="block mb-2 text-xl font-bold text-black">Your email:</label>
          <input type="text" name="emailForgot" id="email-forgot" class="bg-gray-50 border border-gray-300 
                     ...
                     block w-full p-2.5" placeholder="Enter your email hear to recover password"  required>
        </div>
