<%@page contentType="text/html" pageEncoding="UTF-8" %>
  <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
    <%String root=request.getContextPath();%>
      ...
      <body>
        <form action="<%=root%>/admin/showtimes" method="get" class="px-72 py-4 bg-[#3D4857E1]">
          ...
          <div class="relative">
            ...
            <input type="search" id="default-search" name="movieName"
                   ...
                   placeholder="Movie" value="${movieName}" required>
            <button type="submit"
                  ...
                  <div class="relative p-4 w-full max-w-md max-h-full">
                    <div class="relative rounded-lg shadow bg-gray-700">
                      ...
                      <div class="p-4 md:p-5 text-center">
                        ...
                        <h3 class="mb-5 text-lg font-normal text-gray-400">Are you sure you want to delete this seat
                          class?</h3>
