          ...
          <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative rounded-lg shadow bg-white">
              ...
              <div class="p-4 md:p-5 text-center">
                ...
                <h3 class="mb-5 text-lg font-normal text-black">You can only refund before 2
                  days of showdate</h3>
                ...
                <form method="post" action="<%=root%>/ticket/refund">
                  ...
                  <button data-modal-hide="refund_modal" type="button"
                          class="text-white bg-gray-600 px-5 py-2.5 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-800 font-medium rounded-lg text-sm inline-flex items-center text-center me-2">NO</button>
                </form>
              </div>
            </div>
          </div>
