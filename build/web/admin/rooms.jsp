...
<html lang="en">
  ...
  <body>
      ...
      <div class="content ml-64 px-4 h-[100vh] pt-4">
        ...
        <c:choose>
          <c:when test="${action == 'update' || action == 'add'}">
            <!-- update form -->
            <c:import url="${root}/AdminComponent/Update/room.jsp"/>
          </c:when>    
          <c:otherwise>
            <!-- Movies table -->
              ...
              <table
                ...
                <thead class="text-xs uppercase bg-gray-700 text-gray-400">
                  <tr>
                    ...
                    <th scope="col" class="px-6 py-3">Max seats</th>
                    <th scope="col" class="px-6 py-3">Screen quality</th>
                ...
                <tbody>
                  <c:forEach var="room" items="${rooms}">
                    <tr class="border-b bg-gray-800 border-gray-700">
                      ...
                      <td class="px-6 py-2">${room.getMaxSeats()}</td>
                      <td class="px-6 py-2">${room.getScreenQuality()}</td>
                      <td class="px-6 py-2">
                        <a href="<%=root%>/admin/rooms?action=update&roomNumber=${room.getRoomNumber()}" class="font-medium text-blue-500 hover:underline"
                           >Edit</a
                        >
                      </td>
                      <td class="px-6 py-2">
                        <button data-modal-target="delete_modal" data-room-number=${room.getRoomNumber()} data-modal-toggle="delete_modal" class="block text-white focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-blue-600 hover:bg-blue-700 focus:ring-blue-800" type="button">
                          Delete
                        </button>
                      </td>
                    </tr>
            ...
            <!--Add Movie-->
            <form method="get" action="<%=root%>/admin/rooms">
              ...
              <div class="relative p-4 w-full max-w-md max-h-full">
                <div class="relative rounded-lg shadow bg-gray-700">
                  ...
                  <div class="p-4 md:p-5 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-gray-400">Are you sure you want to delete this room?</h3>

                    <!--FORM TO DELETE SERVLET-->
                    <form method="post" action="<%=root%>/admin/rooms">
    ...
    <script>
      ...
      let roomNumber;
      const roomDeleteButtons = document.querySelectorAll('[data-room-number]');
      ...
      for (let roomDeleteButton of roomDeleteButtons) {
        roomDeleteButton.addEventListener("click", (e) => {
          ...
          roomNumber = roomDeleteButton.getAttribute("data-room-number");
